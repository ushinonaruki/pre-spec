export const UI_TEXT = {
  app: {
    ...
    exportButton: '📥 出力',
    autosaveError: '作業状態の自動保存に失敗しました。',
  },
  ...
  featurePanel: {
    ...
    requirementMemoLabel: '要件定義メモ (.md / .txt)',
    requirementMemoFileButton: 'ファイルを選択',
    requirementMemoFileSelected: (name: string) => `選択中: ${name}`,
    requirementMemoReadError: 'ファイルの読み込みに失敗しました。別のファイルを選択してください。',
    requirementMemoRequired: '要件定義メモを選択してください',
    relatedAddButton: '+ 追加',
    relatedRemoveButton: '✕',
    relatedFileMode: 'ファイル',
    relatedUrlMode: 'URL',
