export const UI_TEXT = {
  ...
  startScreen: {
    ...
    openWorkFileNameError: 'ファイル名の形式が正しくありません。{projectFileBase}.pre-spec.json を選択してください。',
    newProject: '新規作成',
    fileBaseLabel: 'ファイル名ベース',
    fileBasePlaceholder: '例: user-auth-feature',
    fileBaseRequired: 'ファイル名ベースを入力してください',
    fileBaseInvalid: '使用できない文字が含まれています',
