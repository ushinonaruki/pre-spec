export const UI_TEXT = {
  ...
  featurePanel: {
    ...
    createSaveError: 'Feature の作成後の保存に失敗しました。ファイルの書き込み権限を確認してください。',
    renameSaveError: 'Feature のリネーム後の保存に失敗しました。ファイルの書き込み権限を確認してください。',
  ...
  export: {
    ...
    preflightOpenQuestions: (n: number) => `  未回答の質問: ${n}件`,
    preflightMarkersHeader: '  marker:',
